        ...
        >
          ...
          >
            <div>
              ...
              <div style={{ display: "flex", gap: "0.55rem", flexWrap: "wrap", margin: "1rem 0" }}>
                {[
                  {
                  ...
                  },
                  {
                    ...
                    label: "PhilPeople",
                    icon: <span style={{ fontFamily: "Cinzel, serif", fontSize: "0.95rem", fontWeight: 700, lineHeight: 1 }}>φ</span>
                  },
                  {
